     ...
     <p style={{textAlign: 'center', width: '100%'}}>Made by NeroPako</p>
      ...
      {!token ? (
          <div style={{textAlign: 'center', width: '100%', display: 'flex', alignContent: 'center', justifyContent: 'center'}}>
             <p>You must login to your FastMail account to continue. Type your Api Token and press save.</p>
             <p>This token won't leave the browser and will not be shared with anyone else.</p>
